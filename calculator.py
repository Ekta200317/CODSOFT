...
input_field = Entry(input_frame, font=('Grotesque', 30, 'bold'), textvariable=input_text, width=50, bg="white", bd=0, justify=RIGHT)
...
button_fr = Frame(win, width=314, height=272.5, bg="white")

button_fr.pack()

# row 1

clear = Button(button_fr, text = "Clear(CE)", fg = "black", width = 32, height = 3, bd = 0, bg = "orange", cursor = "hand2", command = lambda: bt_clear()).grid(row = 0, column = 0, columnspan = 3, padx = 1, pady = 1)

divide = Button(button_fr, text = "/", fg = "white", width = 10, height = 3, bd = 0, bg = "grey", cursor = "hand2", command = lambda: btn_click("/")).grid(row = 0, column = 3, padx = 1, pady = 1)
...
multiply = Button(button_fr, text = " * ", fg = "white", width = 10, height = 3, bd = 0, bg = "grey", cursor = "hand2", command = lambda: btn_click("*")).grid(row = 1, column = 3, padx = 1, pady = 1)
...
minus = Button(button_fr, text = "-", fg = "white", width = 10, height = 3, bd = 0, bg = "grey", cursor = "hand2", command = lambda: btn_click("-")).grid(row = 2, column = 3, padx = 1, pady = 1)
...
plus = Button(button_fr, text = "+", fg = "white", width = 10, height = 3, bd = 0, bg = "grey", cursor = "hand2", command = lambda: btn_click("+")).grid(row = 3, column = 3, padx = 1, pady = 1)

# row 4

zero = Button(button_fr, text = "0", fg = "white", width = 21, height = 3, bd = 0, bg = "grey", cursor = "hand2", command = lambda: btn_click(0)).grid(row = 4, column = 0, columnspan = 2, padx = 1, pady = 1)
point = Button(button_fr, text = ".", fg = "white", width = 10, height = 3, bd = 0, bg = "grey", cursor = "hand2", command = lambda: btn_click(".")).grid(row = 4, column = 2, padx = 1, pady = 1)

equals = Button(button_fr, text = "=", fg = "white", width = 10, height = 3, bd = 0, bg = "red", cursor = "hand2", command = lambda: bt_equal()).grid(row = 4, column = 3, padx = 1, pady = 1)
